...
以下是一块测力台的零件，如果要制作两块进行双脚测试，数量×2即可。
...
>单个传感器200kg量程，四个800kg。如果200kg缺货，用100kg的也可以。要跟客服确认线多长，装在钢板上长度是否足够。
...
## 3 装配
### 3.1 传感器剥线
用鸭嘴剥线钳或小刀，将所有测力传感器的四根线末端剥出约1cm长的金属线，然后将相同颜色的金属线部分拧到一起，最后按红、黑、白、绿（或红、黑、绿、白）顺序插到接线端子里，用螺丝刀拧紧固定好。
